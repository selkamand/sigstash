...
![GitHub Issues or Pull Requests](https://img.shields.io/github/issues-closed/selkamand/sigstash)
[![code size](https://img.shields.io/github/languages/code-size/selkamand/sigstash.svg)](https://github.com/selkamand/sigstash)
![GitHub last commit](https://img.shields.io/github/last-commit/selkamand/sigstash)
<!-- badges: end -->
